...
class QuestionMethodTests(TestCase):
	...
	def test_was_published_recently_with_future_question(self):
		...
		"""was published recently() should return False for question whose pub_date is in the future."""
	...
	def test_was_published_recently_with_recent_question(self):
		...
		recent_question=quwstion(pub_date=time)
		self.assertIs(recent_question.was_published_recently(),True)

def create_question(question_text,days):
		"""Creates a question with the given `question_text` and published the given number of `days` offset to now (negative for question published in the past, positive for questions that have yet to be published)."""
